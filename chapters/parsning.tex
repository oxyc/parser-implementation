...
En fritt tillgänglig version av Lex är Flex som distribueras av bl.a. GNU
projektet. I allmänhet är Flex kompatibel med Lex och är därför ett populärt
alternativ \citep[s. 279]{bd92}.
...
GNU projektet har även skapat en copyleft-licenseriad version av Yacc som
...
Jison är en JavaScript skriven parser-generator för både reguljära grammatiker

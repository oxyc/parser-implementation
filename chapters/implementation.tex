...
Eftersom token-objekt innehåller information om dess rad och kolumn i input är
...
Den nya \bnfrule{sats}-grammatiken hittas i figur~\ref{fig:stat}.
...
Ett exempel på syntaxträdet genererat från en parsning hittas i
figur~\ref{fig:tool}.

...
\clearpage
\addcontentsline{toc}{section}{Bilaga 4. Skript för prestanda analys i JavaScript}
\section*{Bilaga 4. Skript för prestanda analys i JavaScript}

\lstinputlisting[title="",language=Javascript]{figures/tex/benchmark.js}

\clearpage
\addcontentsline{toc}{section}{Bilaga 5. Skript för prestanda analys i Lua}
\section*{Bilaga 5. Skript för prestanda analys i Lua}
